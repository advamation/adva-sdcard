...
- parse + print CID-data: `adva-sdcard-info CID_AS_HEX_STRING`
- read, parse + print:

      adva-sdcard-info /sys/block/mmcblk0/device/
      # or
      adva-sdcard-info -d /dev/mmcblk0
      # or
      cat /sys/block/mmcblk0/device/ | adva-sdcard-info
...
- `adva-sdcard-smart`:
  ...
  - optionally incl. call to `adva-sdcard-smart-get`
  - examples:
...
- Examples:
      ...
      $ sudo adva-sdcard-smart-get /dev/mmcblk0 | adva-sdcard-smart-get -a -p
      type: T
